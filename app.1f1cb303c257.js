    ...
    function showPage(html){
      ...
      pageView.innerHTML='<div class="psticky" id="psticky"><div class="psticky-in"><span class="psticky-nm" id="psticky-nm"></span><button class="psticky-play" id="psticky-play" type="button" aria-label="Play"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></button></div></div><div id="page-body">'+html+'</div>';   // no back button — browser/PWA back + the bottom nav cover navigation
