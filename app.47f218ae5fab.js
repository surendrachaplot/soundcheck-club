    ...
    function pdShelfCardHTML(title, artists, key, icon){
      var SHOW=6, list=artists||[], more=list.length>SHOW?'<div class="pd-card-foot"><button class="pd-more" type="button" data-more="'+key+'">See more <i class="ti ti-arrow-right" aria-hidden="true"></i></button></div>':'';
