    ...
    function buildDayStrip(){
      ...
      if(_stripFocus){
        var fh=_dtTile(today, true);
        for(var fd=_addDaysISO(_stripFocus,-3); fd<=_addDaysISO(_stripFocus,3); fd=_addDaysISO(fd,1)){ if(fd>today) fh+=_dtTile(fd, false); }
        stripEl.innerHTML=fh+_calTile(); return;
      }
