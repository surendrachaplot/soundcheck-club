    ...
    function pdDiaryCardHTML(diary, isMe){
      ...
      var stubs=diary.slice(0,4).map(function(d){
      ...
      return '<section class="pd-card pd-diary"><div class="pd-card-head"><h2 class="pd-title">Gig diary <span class="pd-cnt">×'+diary.length+'</span></h2>'+loggig+'</div><div class="pd-perf"></div><div class="pd-stubs">'+(stubs||'<div class="empty" style="padding:6px 2px">No gigs logged yet.</div>')+'</div></section>';
    }
