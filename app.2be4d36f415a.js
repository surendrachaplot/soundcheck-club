    ...
    function mountBill(items){
      ...
      if(!items.length){ box.innerHTML='<div class="pf-box" style="margin-top:20px">'+pfHead('Lineup',null,'')+'<div class="empty" style="padding:2px 0">To be announced.</div></div>'; return; }
      box.innerHTML='<div class="pf-box" style="margin-top:20px">'+pfHead('Lineup',items.length,'')+billRowsHTML(items)+'</div>';
