    ...
    function pdDiaryCardHTML(diary, isMe){
      ...
      var stubs=diary.slice(0,PREV).map(function(d){
        ...
        var acts=arts.slice(0,6).map(function(a){ return '<span class="pd-achip" data-artist="'+esc(a.slug||'')+'"><span class="pd-abub" style="'+pdBub(a,false)+'"></span>'+esc(a.name||a.slug)+'</span>'; }).join('');
    ...
    async function openDiaryPage(handle, isMe){
      ...
      try{
        ...
        var body='<div class="pd-page diary-page" style="max-width:760px">'+
          '<div class="sec-h" style="margin-top:8px">Gig diary<span class="ct">'+diary.length+'</span>'+logBtn+'</div>'+
