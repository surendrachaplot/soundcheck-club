    ...
    function tasteCardHTML(p){
      ...
      return '<div class="tb-pass tb-card">'+
        '<div class="tb-main">'+
          '<div class="tb-head"><span class="tb-avatar" style="background-image:'+avbg+';background-size:cover;background-position:center"></span><div class="tb-hid"><div class="tb-name">'+name+'</div></div><span class="tb-season">'+yr+' season</span></div>'+
