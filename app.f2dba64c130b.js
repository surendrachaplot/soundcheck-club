    ...
    function _renderStrip(coreHTML, lastISO){
      ...
      // fill with weekend days only (Fri/Sat/Sun) — Mon–Thu always stay collapsed in the ···
      while(added<approx && k++<420){ last=_addDaysISO(last,1); var dw=new Date(last+'T12:00:00').getDay(); if(dw===5||dw===6||dw===0){ html+=_dtTile(last); added++; } }
