    ...
    function tasteCardHTML(p){
      ...
      var s=p.shelves||{wannaSee:[],seen:[],events:[],venues:[]}, st=p.stats||{}, diary=p.diary||[];
      var handle=p.handle, name=esc(p.displayName||('u/'+handle));
      var since=st.firstGig?String(new Date(st.firstGig).getFullYear()):'';
      ...
      return '<div class="tb-pass tb-card">'+
        '<div class="tb-main">'+
          '<div class="tb-head"><div class="tb-logo">S</div><b class="tb-wm">soundcheck</b></div>'+
          '<div class="tb-pax"><span class="tb-avatar" style="background-image:'+avbg+';background-size:cover;background-position:center"></span><div class="tb-paxL"><div class="tb-name">'+name+'</div><div class="tb-handle">@'+esc(handle)+(since?' · since '+since:'')+'</div></div></div>'+
