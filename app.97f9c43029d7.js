      ...
      return '<div class="ev-layout">'+
          ...
          '<div class="ev-col-main">'+
            '<div class="event-head-tx">'+
              ...
              (eid ? '<div class="artist-actions" style="margin-top:16px">'+((ev.artists||[]).length?'<button class="act-btn radio" id="ev-playbill" type="button">'+RADIO_SVG+'<span>Play the line-up</span></button>':'')+(isPast?evLog:evHeart)+evShare+'</div>' : '')+
            '</div>'+
