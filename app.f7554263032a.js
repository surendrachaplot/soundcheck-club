    ...
    function cardHTML(ev){
      ...
      // single meta line under the image: day · time · venue · city
      var when = (dayLab||'') + ((dayLab&&t1)?' · ':'') + (t1||'');
      var meta = [when, esc(ev.venue||'TBA'), ev._city?esc(ev._city):''].filter(Boolean).join(' &middot; ');
