    ...
    function loadVenueCoords(){
      ...
      return pubGet('/api/venues/map?city='+encodeURIComponent(city)).then(function(j){
        var m={}; (j.venues||[]).forEach(function(v){ if(v.lat!=null && v.lng!=null) m[v.slug||venueKey(v.name)]=[+v.lat,+v.lng]; });
